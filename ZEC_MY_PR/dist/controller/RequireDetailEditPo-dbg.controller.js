...
], function(BaseController, JSONModel, GroupHeaderListItem, Priority, MessageToast, Filter, History, ODataModel, Core, Controller,
	Validator, ValueHelpHelper) {
	"use strict";
	// var editItem = [];
	var jsonmodel = new JSONModel();
	return BaseController.extend("ZEC_MY_REQUIREMENTS.controller.RequireDetailEditPo", {
		onInit: function() {

			this.getOwnerComponent().getRouter().getRoute("requireEditPo").attachPatternMatched(this._onRequestEditMatched, this);
